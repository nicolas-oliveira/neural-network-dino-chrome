...
void ConfiguracoesIniciais()
{
    ...
    Fonte               = CriarFonteNormal("./lib/fontes/arial.ttf", 15, PRETO,      0, PRETO);
    FonteVermelha       = CriarFonteNormal("./lib/fontes/arial.ttf", 15, VERMELHO,   0, PRETO);
    FonteAzul           = CriarFonteNormal("./lib/fontes/arial.ttf", 15, AZUL,       0, PRETO);
    DistanciaRecorde    = 0;
    Geracao             = 0;
